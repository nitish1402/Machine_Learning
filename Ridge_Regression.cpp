 ...
 * according to gradient descent algorithm using ridge regreesion
...
double lembda=100; //regularised parameter
...
int main()
{
    ...
    double alpha=0.0000001; //sensitivity
    double d[7]={0.0};
    ...
    cout<<"----------Gradient Descent Ridge Regression----------------------"<<endl;
    cout<<"------------------------------------------------------------------"<<endl;
    cout<<"------------------------------------------------------------------"<<endl;
    ...
    for(i=0;i<200000;i++)
    {
		...
		for(j=0;j<7;j++)
		{
			...
			//applying regularisation here
			theta[j]-=alpha*lembda/m;
		}
